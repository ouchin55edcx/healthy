...
@section('content')
    <section class=" py-16 md:py-32"
        style="background-image: url('storage/images/img1.jpg'); background-size: cover; background-position: center;">
    ...
    {{-- Hospital Services --}}
    <div class="mt-8">
        <h1 class="text-bold text-4xl text-center ">Hospital Services</h1>
    </div>
    <div class="mt-8 grid gap-8 sm:grid-cols-2 lg:grid-cols-3 p-4 md:p-8">
        ...
        <div
            ...
            <div class="space-y-12">
                ...
                <div class="space-y-4">
                    <h3 class="text-2xl font-semibold text-gray-800 transition">Patient Data Collection</h3>
                    <p class="text-gray-600">Effortlessly upload diverse patient datasets containing various medical
                        information for thorough analysis.</p>
                </div>
            </div>
        </div>
        ...
        <div
            ...
            <div class="space-y-12">
                ...
                <div class="space-y-4">
                    <h3 class="text-2xl font-semibold text-gray-800 transition">Medical Model Training</h3>
                    <p class="text-gray-600">Enable our advanced AI models to learn patterns and insights from the provided
                        medical data. This process may take some time to ensure accuracy.</p>
                </div>
            </div>
        </div>

        <!-- Service 3: Insights Delivery -->
        <div
            class="p-8 py-12 sm:p-12 rounded-3xl bg-white border border-gray-100 bg-opacity-50 shadow-2xl shadow-gray-600/10">
            <div class="space-y-12">
                ...
                <div class="space-y-4">
                    <h3 class="text-2xl font-semibold text-gray-800 transition">Medical Insights Delivery</h3>
                    <p class="text-gray-600">Receive comprehensive medical insights and analysis results based on the
                        trained AI model, aiding healthcare professionals in making informed decisions.</p>
                </div>
            </div>
        </div>
    </div>
