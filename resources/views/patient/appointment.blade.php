...
@section('content')
    ...
    <div class="max-w-xs mx-auto bg-white shadow-md rounded-lg overflow-hidden m-8">
        <a href="{{ route('patient.doctorProfile') }}" class="flex justify-center">
            <img class="h-32 w-auto object-cover rounded-full" src="storage/images/docotr1.png" alt="Doctor Image">
        </a>
        <div class="px-4 py-3 text-center">
            <a href="{{ route('patient.doctorProfile') }}">
                <h3 class="text-gray-900 font-semibold text-lg mb-1 tracking-tight">Dr. John Doe</h3>
            </a>
            <p class="text-gray-600 text-sm mb-2">Specialty: Cardiology</p>
